...
/* harmony import */ var _badge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./badge */ "./badge.js");
/* harmony import */ var _badge_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./badge_config */ "./badge_config.js");
/* harmony import */ var _metrics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./metrics */ "./metrics.js");




/*
 * Called to add badges given the to all badge containers in scope.
 */
var addBadges = function addBadges() {
  var containers = document.querySelectorAll('.__dimensions_badge_embed__');
  if (!containers.length) return;
  var _loop = function _loop(i) {
    var config = new _badge_config__WEBPACK_IMPORTED_MODULE_1__["default"](containers[i].attributes, window.__dimensions_detail_url, window.__dimensions_metrics_api, window.__dimensions_badge_server);
    if (!!config.metricsURL) {
      new _metrics__WEBPACK_IMPORTED_MODULE_2__["default"](config.metricsURL).fetch(function (metrics) {
        new _badge__WEBPACK_IMPORTED_MODULE_0__["default"](containers[i], config, metrics).load();
      });
    }
  };
...
/* harmony default export */ __webpack_exports__["default"] = (addBadges);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* We need to add the badge stylesheet to the document separately to
 * avoid the requirement for a style loader inside Webpack, which
 * bumps up the embed script size. */
var addStyles = function addStyles() {
  var styleNode = document.createElement('link');
  styleNode.rel = 'stylesheet';
  styleNode.href = "".concat(window.__dimensions_badge_url, "/badge.css");
...
/* harmony import */ var _templates_circle_html_template__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./templates/circle.html.template */ "./templates/circle.html.template");
/* harmony import */ var _templates_rectangle_html_template__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./templates/rectangle.html.template */ "./templates/rectangle.html.template");
/* harmony import */ var _number_helper__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./number_helper */ "./number_helper.js");
...
var Badge = /*#__PURE__*/function () {
  function Badge(component, config, metrics) {
    var _this = this;
    _classCallCheck(this, Badge);
    _defineProperty(this, "onMouseOver", function () {
      _this.badgeComponent.className = "__dimensions_Badge __dimensions_Badge_style_".concat(_this.config.badgeType, " __dimensions_Badge_hover");
      if (!_this.legendComponent) return;
      switch (_this.config.legendDisplay) {
        case 'always':
        case 'never':
          return;
        case 'hover-top':
        ...
        case 'hover-bottom':
        case 'hover-left':
          _this.legendComponent.className = "__dimensions_Badge_Legend_padding __dimensions_Badge_Legend_hover __dimensions_Badge_Legend_".concat(_this.config.legendDisplay, "  __dimensions_Badge_Legend_style_").concat(_this.config.badgeType);
          break;
        case 'hover-auto':
          _this.legendComponent.className = "__dimensions_Badge_Legend_padding __dimensions_Badge_Legend_hover __dimensions_Badge_Legend_hover-".concat(_this.optimalHoverDirection, "  __dimensions_Badge_Legend_style_").concat(_this.config.badgeType);
          break;
      }
    });
    _defineProperty(this, "onMouseOut", function () {
      _this.badgeComponent.className = "__dimensions_Badge __dimensions_Badge_style_".concat(_this.config.badgeType);
      if (!_this.legendComponent) return;
      switch (_this.config.legendDisplay) {
        case 'always':
        case 'never':
          return;
        default:
          _this.legendComponent.className = "__dimensions_Badge_Legend_padding  __dimensions_Badge_Legend_style_".concat(_this.config.badgeType);
      }
    });
    _defineProperty(this, "trigger", function (eventName) {
      window.setTimeout(function () {
        var event = document.createEvent('Event');
        event.initEvent(eventName, true, true);
        _this.component.dispatchEvent(event);
      });
    });
  ...
  return _createClass(Badge, [{
    ...
    value: function load() {
      ...
      if (this.hidden) {
        this.trigger('dimensions_embed:hide');
        return;
      }
      this.buildElements();
      this.installElements();
      this.trigger('dimensions_embed:show');
    }
  }, {
    key: "supportsSVG",
    value: function supportsSVG() {
      return !!('createElementNS' in document && document.createElementNS('http://www.w3.org/2000/svg', 'svg').createSVGRect) && this.testGradient();
    }
  }, {
    key: "testGradient",
    value: function testGradient() {
      var property = 'background-image:linear-gradient(black,white),radial-gradient(black,white)';
      var el = document.createElement('temp');
      el.style.cssText = property;
      var isSupported = el.style['backgroundImage'] !== '';
      return isSupported;
    }
  }, {
    key: "buildElements",
    value: function buildElements() {
      this.wrapperComponent = this.buildWrapper();
      this.badgeComponent = this.buildBadge();
      this.legendComponent = this.buildLegend();
    }
  }, {
    key: "installElements",
    value: function installElements() {
      if (this.badgeComponent) {
        this.wrapperComponent.appendChild(this.badgeComponent);
      }
      if (this.legendComponent) {
        this.wrapperComponent.appendChild(this.legendComponent);
      }
      this.component.appendChild(this.wrapperComponent);
      this.component.setAttribute('data-dimensions-badge-installed', true);
    }
  }, {
    key: "buildWrapper",
    value: function buildWrapper() {
      ...
      wrapper.className = '__dimensions_Link';
      wrapper.href = this.config.detailPageURL;
      wrapper.target = '_blank';
      wrapper.style.display = 'none';
      wrapper.setAttribute('referrerpolicy', 'no-referrer-when-downgrade');
      wrapper.setAttribute('aria-label', this.altScoreText);
      wrapper.addEventListener('focus', this.onMouseOver);
      wrapper.addEventListener('blur', this.onMouseOut);
      wrapper.addEventListener('mouseover', this.onMouseOver);
      wrapper.addEventListener('mouseout', this.onMouseOut);
      window.addEventListener('touchstart', function () {
        wrapper.removeEventListener('mouseover', _this2.onMouseOver);
        wrapper.removeEventListener('mouseout', _this2.onMouseOut);
        wrapper.removeEventListener('focus', _this2.onMouseOver);
        wrapper.removeEventListener('blur', _this2.onMouseOut);
      });
      return wrapper;
    }
  }, {
    key: "buildBadge",
    value: function buildBadge() {
      var template = this.template;
      var label = this.metrics.timesCited === 1 ? 'CITATION' : 'CITATIONS';
      var sizeClass = this.textContent.length > 3 ? 'small' : 'normal';
      var svgContent = template.replace(/\{\{SCORE\}\}/g, this.textContent).replace(/\{\{SIZE\}\}/g, sizeClass).replace(/\{\{LABEL\}\}/g, label).replace(/\{\{ID\}\}/g, this.id).replace(/\{\{BADGE_SERVER_URL\}\}/g, this.config.badgeServerURL).replace(/\{\{ALT_SCORE\}\}/g, this.altScoreText);
      var badgeElement = document.createElement('div');
      badgeElement.className = "__dimensions_Badge __dimensions_Badge_style_".concat(this.config.badgeType);
    ...
    value: function buildLegend() {
      if (this.legendHidden) return;
      var legendPaddingElement = document.createElement('div');
      legendPaddingElement.className = "__dimensions_Badge_Legend_padding __dimensions_Badge_Legend_hover-right  __dimensions_Badge_Legend_style_".concat(this.config.badgeType);
      if (this.legendAlwaysVisible) {
        legendPaddingElement.className += ' __dimensions_Badge_Legend_always';
      }
      var legendElement = document.createElement('div');
      legendElement.className = '__dimensions_Badge_Legend';
      legendPaddingElement.appendChild(legendElement);
      legendElement.innerHTML = "\n      <div class='__dimensions_Badge_stat_group __dimensions_Badge_stat_group_citations'>\n        <div class='__dimensions_Badge_stat __dimensions_Badge_stat_total_citations'>\n          <span class='__dimensions_Badge_stat_icon'></span>\n          <span class='__dimensions_Badge_stat_count'>".concat((0,_number_helper__WEBPACK_IMPORTED_MODULE_17__.formatThousands)(this.timesCited), "</span>\n          <span class='__dimensions_Badge_stat_text'>Total ").concat(this.timesCited == 1 ? 'citation' : 'citations', "</span>\n        </div>\n        <div class='__dimensions_Badge_stat __dimensions_Badge_stat_recent_citations'>\n          <span class='__dimensions_Badge_stat_icon'></span>\n          <span class='__dimensions_Badge_stat_count'>").concat((0,_number_helper__WEBPACK_IMPORTED_MODULE_17__.formatThousands)(this.recentCitations), "</span>\n          <span class='__dimensions_Badge_stat_text'>Recent ").concat(this.recentCitations == 1 ? 'citation' : 'citations', "</span>\n        </div>\n      </div>\n      <div class=\"__dimensions_Badge_stat_group __dimensions_Badge_stat_group_cr\">\n        <div class='__dimensions_Badge_stat __dimensions_Badge_stat_fcr'>\n          <span class='__dimensions_Badge_stat_icon'></span>\n          <span class='__dimensions_Badge_stat_count'>").concat((0,_number_helper__WEBPACK_IMPORTED_MODULE_17__.formatRatio)(this.metrics.fcr), "</span>\n          <span class='__dimensions_Badge_stat_text'>Field Citation Ratio</span>\n        </div>\n        <div class='__dimensions_Badge_stat __dimensions_Badge_stat_rcr'>\n          <span class='__dimensions_Badge_stat_icon'></span>\n          <span class='__dimensions_Badge_stat_count'>").concat((0,_number_helper__WEBPACK_IMPORTED_MODULE_17__.formatRatio)(this.metrics.rcr), "</span>\n          <span class='__dimensions_Badge_stat_text'>Relative Citation Ratio</span>\n        </div>\n      </div>");
      return legendPaddingElement;
    }
  }, {
    key: "template",
    get: function get() {
      switch (this.config.badgeType) {
        ...
        case 'large_circle':
        default:
          return _templates_circle_html_template__WEBPACK_IMPORTED_MODULE_15__["default"];
        case 'small_rectangle':
        case 'large_rectangle':
          return _templates_rectangle_html_template__WEBPACK_IMPORTED_MODULE_16__["default"];
      }
    }
  }, {
    key: "hidden",
    ...
    key: "textContent",
    get: function get() {
      return this.noMetrics ? '?' : (0,_number_helper__WEBPACK_IMPORTED_MODULE_17__.formatThousands)(this.metrics.timesCited);
    }
  }, {
    key: "noCitations",
    get: function get() {
    ...
    key: "legendHidden",
    get: function get() {
      return this.config.legendDisplay === 'never';
    }
  }, {
    key: "legendAlwaysVisible",
    get: function get() {
      return this.config.legendDisplay === 'always';
    }
  }, {
    key: "timesCited",
    get: function get() {
    ...
    key: "recentCitations",
    get: function get() {
      return this.noMetrics ? '?' : (0,_number_helper__WEBPACK_IMPORTED_MODULE_17__.formatThousands)(this.metrics.recentCitations);
    }
  }, {
    key: "optimalHoverDirection",
    get: function get() {
      var xPos = this.badgeComponent.getBoundingClientRect().x;
      var threshold = window.innerWidth / 2;
      return xPos > threshold ? 'left' : 'right';
    }
  }, {
    key: "altScoreText",
    get: function get() {
      if (this.metrics.timesCited === 1) {
        return '1 citation on Dimensions.';
      }
      return this.textContent + ' total citations on Dimensions.';
    }
  }]);
}();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ BadgeConfig; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol.js */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description.js */ "./node_modules/core-js/modules/es.symbol.description.js");
...
/* harmony import */ var _identifiers__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./identifiers */ "./identifiers.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var VALID_LEGEND_STYLES = ['never', 'always', 'hover-auto', 'hover-top', 'hover-right', 'hover-bottom', 'hover-left'];
var VALID_BADGE_STYLES = ['small_circle', 'medium_circle', 'large_circle', 'small_rectangle', 'large_rectangle'];
var BadgeConfig = /*#__PURE__*/function () {
  function BadgeConfig() {
    var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var detailPageHost = arguments.length > 1 ? arguments[1] : undefined;
    var dimensionsMetricsApi = arguments.length > 2 ? arguments[2] : undefined;
    var badgeServerURL = arguments.length > 3 ? arguments[3] : undefined;
    _classCallCheck(this, BadgeConfig);
    _defineProperty(this, "hideWhenZeroCitations", false);
    this.detailPageHost = detailPageHost;
    this.dimensionsMetricsApi = dimensionsMetricsApi;
    this.badgeServerURL = badgeServerURL;
    this.legendDisplay = 'hover-auto';
    this.badgeType = 'medium_circle';
    for (var i = 0; i < attributes.length; i++) {
      ...
      switch (attr.name) {
        ...
        case 'data-id':
          ...
          break;
        case 'data-pmid':
          this.pmid = attr.value;
          break;
        case 'data-hide-zero-citations':
          this.hideWhenZeroCitations = attr.value.toLowerCase() !== 'false';
          break;
        case 'data-legend':
          if (VALID_LEGEND_STYLES.indexOf(attr.value) >= 0) {
            this.legendDisplay = attr.value;
          }
          break;
        case 'data-style':
          if (VALID_BADGE_STYLES.indexOf(attr.value) >= 0) {
            this.badgeType = attr.value;
          }
          break;
      }
    }
  }
  return _createClass(BadgeConfig, [{
    ...
    get: function get() {
      if (this.id) {
        return new _identifiers__WEBPACK_IMPORTED_MODULE_14__.DimensionsID(this.id);
      } else if (this.doi) {
        return new _identifiers__WEBPACK_IMPORTED_MODULE_14__.DOI(this.doi);
      } else if (this.pmid) {
        return new _identifiers__WEBPACK_IMPORTED_MODULE_14__.PubmedID(this.pmid);
      }
    }
  }, {
    key: "metricsURL",
    get: function get() {
      var identifier = this.preferredIdentifier;
      if (!identifier) {
        return null;
      }
      return "".concat(this.dimensionsMetricsApi, "/").concat(identifier.type, "/").concat(identifier.value);
    }
  }, {
    key: "detailPageURL",
    get: function get() {
      var identifier = this.preferredIdentifier;
      var pageUrl = "".concat(this.detailPageHost, "/details/").concat(identifier.type, "/").concat(identifier.value);
      if (window.location.host) {
        pageUrl += "?domain=".concat(window.location.protocol, "//").concat(window.location.host);
      }
      return pageUrl;
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (delayable);
 ...
 * @returns {void}
 **/
var onDOMContentLoaded = function onDOMContentLoaded(fn) {
  // IE10 and lower don't handle "interactive" document.readyState properly, which
  // means we have to change the comparison we use for detecting if the page has
  // already loaded.
  if (document.attachEvent ? document.readyState === 'complete' : document.readyState !== 'loading') {
    fn();
  } else {
    document.addEventListener('DOMContentLoaded', fn);
    document.onreadystatechange = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
...
/**
 * @typedef Config
 * @property {string} metrics Metrics API endpoint.
 * @property {string} metrics Metrics API endpoint.
 * @property {string} metrics Metrics API endpoint.
 * @property {string} metrics Metrics API endpoint.
 */
 ...
 * @return {Promise<Config>} A promise
 **/

var getServerConfig = function getServerConfig(endpoint) {
  if (!!endpoint) {
  ...
  return Promise.reject('Config endpoint not found or invalid.');
};
...
/* harmony export */   DimensionsID: function() { return /* binding */ DimensionsID; },
/* harmony export */   PubmedID: function() { return /* binding */ PubmedID; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol.js */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description.js */ "./node_modules/core-js/modules/es.symbol.description.js");
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var Identifier = /*#__PURE__*/_createClass(function Identifier(str) {
  _classCallCheck(this, Identifier);
  this.value = str;
});
var DOI = /*#__PURE__*/function (_Identifier) {
  function DOI() {
    var _this;
    _classCallCheck(this, DOI);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, DOI, [].concat(args));
    _defineProperty(_this, "type", 'doi');
    return _this;
  }
  _inherits(DOI, _Identifier);
  return _createClass(DOI);
}(Identifier);
var DimensionsID = /*#__PURE__*/function (_Identifier2) {
  function DimensionsID() {
    var _this2;
    _classCallCheck(this, DimensionsID);
    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }
    _this2 = _callSuper(this, DimensionsID, [].concat(args));
    _defineProperty(_this2, "type", 'id');
    return _this2;
  }
  _inherits(DimensionsID, _Identifier2);
  return _createClass(DimensionsID);
}(Identifier);
var PubmedID = /*#__PURE__*/function (_Identifier3) {
  function PubmedID() {
    var _this3;
    _classCallCheck(this, PubmedID);
    for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }
    _this3 = _callSuper(this, PubmedID, [].concat(args));
    _defineProperty(_this3, "type", 'pmid');
    return _this3;
  }
  _inherits(PubmedID, _Identifier3);
  return _createClass(PubmedID);
}(Identifier);
...
/* harmony import */ var xhr__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! xhr */ "./node_modules/xhr/index.js");
/* harmony import */ var xhr__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(xhr__WEBPACK_IMPORTED_MODULE_12__);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var Metrics = /*#__PURE__*/function () {
  ...
  return _createClass(Metrics, [{
    ...
    value: function fetch(callback) {
      var _this = this;
      xhr__WEBPACK_IMPORTED_MODULE_12___default().get(this.url, {
        useXDR: true
        ...
        if (response.statusCode < 200 || response.statusCode >= 300) {
          ...
          _this.exists = true;
          _this.timesCited = data.times_cited;
          _this.recentCitations = data.recent_citations;
          _this.highlyCited1 = data.highly_cited_1;
          _this.highlyCited5 = data.highly_cited_5;
          _this.highlyCited10 = data.highly_cited_10;
          _this.rcr = data.relative_citation_ratio;
          _this.fcr = data.field_citation_ratio;
        }
        callback(_this);
      });
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   formatFloatingPoint: function() { return /* binding */ formatFloatingPoint; },
/* harmony export */   formatNumberWithDelimiter: function() { return /* binding */ formatNumberWithDelimiter; },
/* harmony export */   formatRatio: function() { return /* binding */ formatRatio; },
/* harmony export */   formatThousands: function() { return /* binding */ formatThousands; }
/* harmony export */ });
...
var formatNumberWithDelimiter = function formatNumberWithDelimiter(number) {
  var delimiter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ',';
  if (number) {
    return number.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1".concat(delimiter));
  }
  return '0';
};
var formatThousands = function formatThousands(n) {
  if (typeof n === 'string') return n;
  n = n || 0;
  if (n < 1000) {
    return "".concat(n);
  } else if (n < 10000) {
    var _thousands = String(Math.round(n / 100) / 10);
    return "".concat(_thousands, "k");
  }
  var thousands = String(Math.round(n / 1000));
  return "".concat(thousands, "k");
};
var formatRatio = function formatRatio(n) {
  var roundLimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
  if (n == null || typeof n == 'undefined') {
    return 'n/a';
  } else if (n < roundLimit) {
    return String(Math.round(n * 100) / 100);
  }
  return String(Math.floor(n));
};
var formatFloatingPoint = function formatFloatingPoint(n) {
  if (n == null || typeof n == 'undefined') {
    return 'n/a';
  }
  return +n.toFixed(2);
...
/***/ "./templates/circle.html.template":
/*!****************************************!*\
  !*** ./templates/circle.html.template ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_es_promise__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! core-js/es/promise */ "./node_modules/core-js/es/promise/index.js");
/* harmony import */ var core_js_es_promise__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(core_js_es_promise__WEBPACK_IMPORTED_MODULE_13__);
...
/* harmony import */ var _add_badges__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./add_badges */ "./add_badges.js");
/* harmony import */ var _add_styles__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./add_styles */ "./add_styles.js");
/* harmony import */ var _delayable__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./delayable */ "./delayable.js");
/* harmony import */ var _get_server_config__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./get_server_config */ "./get_server_config.js");
/* harmony import */ var _dom_events__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./dom_events */ "./dom_events.js");
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i["return"]) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
...
// Derive the config endpoint from the script's own URL so that config.json is
// always fetched from the badge server — regardless of which host embeds the
// widget.  document.currentScript is only available synchronously during
// module evaluation, so we capture it here before any await.
var _scriptSrc = typeof document !== 'undefined' && document.currentScript && document.currentScript.src || '';
var _configEndpoint = _scriptSrc ? new URL('/config.json', _scriptSrc).href : typeof CONFIG_ENDPOINT !== 'undefined' ? CONFIG_ENDPOINT : '';

// We may have already included this script before. If we have, then we can
// forego actually doing anything!
if (!window.__dimensions_embed) {
  var isConfigLoaded = function isConfigLoaded() {
    return window.__dimensions_badge_config_loaded__;
  };
  // Define functions that depend on the config being loaded
  var addBadges = (0,_delayable__WEBPACK_IMPORTED_MODULE_18__["default"])(_add_badges__WEBPACK_IMPORTED_MODULE_16__["default"], isConfigLoaded);
  var addStyles = (0,_delayable__WEBPACK_IMPORTED_MODULE_18__["default"])(_add_styles__WEBPACK_IMPORTED_MODULE_17__["default"], isConfigLoaded);
  var defaultBadgeGlobals = /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            _context.p = 1;
            _context.n = 2;
            return (0,_get_server_config__WEBPACK_IMPORTED_MODULE_19__["default"])(_configEndpoint);
          case 2:
            config = _context.v;
            _context.n = 4;
            break;
          case 3:
            _context.p = 3;
            _t = _context.v;
            // Build up a fallback config
            config = {
              DIMENSIONS_BADGE_SERVER: "",
              DIMENSIONS_BADGE_URL: "",
              DIMENSIONS_DETAIL_URL: "",
              DIMENSIONS_METRICS_API: ""
            };
          case 4:
            if (!window.__dimensions_detail_url) {
              window.__dimensions_detail_url = config.DIMENSIONS_DETAIL_URL;
            }
            if (!window.__dimensions_metrics_api) {
              window.__dimensions_metrics_api = config.DIMENSIONS_METRICS_API;
            }
            if (!window.__dimensions_badge_server) {
              window.__dimensions_badge_server = config.DIMENSIONS_BADGE_SERVER;
            }
            if (!window.__dimensions_badge_url) {
              window.__dimensions_badge_url = config.DIMENSIONS_BADGE_URL;
            }
            window.__dimensions_badge_config_loaded__ = true;
          case 5:
            return _context.a(2);
        }
      }, _callee, null, [[1, 3]]);
    }));
    return function defaultBadgeGlobals() {
      return _ref.apply(this, arguments);
    };
  }();

  // Install badges into the page, unless we have already done so. The once-only
  // behaviour is there to catch weird edge-cases in some browsers.
  var install = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            if (!window.__dimensions_embed_installed__) {
              _context2.n = 1;
              break;
            }
          ...
          case 1:
            _context2.n = 2;
            return defaultBadgeGlobals();
          case 2:
            addStyles();
            addBadges();
            window.__dimensions_embed_installed__ = true;
          case 3:
            return _context2.a(2);
        }
      }, _callee2);
  ...
  (0,_dom_events__WEBPACK_IMPORTED_MODULE_20__.onDOMContentLoaded)(function () {
    install();
  });

  // Make the badge activator globally available, so that we can access it from
  // within the badge builder (or possibly client code?)
